"""web_4_may_dev_4067 URL Configuration
...
admin.site.site_title = "web 4 may Admin Portal"
admin.site.index_title = "web 4 may Admin"
...
schema_view = get_schema_view(
    openapi.Info(
        title="web 4 may API",
        default_version="v1",
        description="API documentation for web 4 may App",
    ),
    public=True,
